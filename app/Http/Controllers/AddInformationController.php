...
class AddInformationController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('admin.general_information.show', compact('general_information'));
    }
    public function edit($id)
    {
        ...
        $social_informations = SocialInformations::all();
        $problem = Problem::all();
        $risk = $general_information->assess_patient_risk->risk ?? [];
        $riskOptions = [
            '0.ไม่มีความเสี่ยง' => '0.ไม่มีความเสี่ยง',
            '1.การเจ็บป่วยซ้ำ' => '1.การเจ็บป่วยซ้ำ',
            '2.การทำเเท้ง/ทอดทิ้งบุตร' => '2.การทำเเท้ง/ทอดทิ้งบุตร',
            '3.การทำร้ายผู้อื่น' => '3.การทำร้ายผู้อื่น',
            '4.การถูกล่วงละเมิด/ก่ออาชญากรรม/การเป็นเหยื่่อการค้ามนุษย์' => '4.การถูกล่วงละเมิด/ก่ออาชญากรรม/การเป็นเหยื่่อการค้ามนุษย์',
            '5.การรับเเละเเพร่เชื้อ HIV' => '5.การรับเเละเแพร่เชื้อ HIV',
            '6.การเกิดปัญหาสุขภาพจิต/จิตเวช' => '6.การเกิดปัญหาสุขภาพจิต/จิตเวช',
            '7.การหลบหนี' => '7.การหลบหนี',
            '8.การมีปัญหาครอบครัว' => '8.การมีปัญหาครอบครัว',
            '9.การติดสารเสพติด/เสพซ้ำ' => '9.การติดสารเสพติด/เสพซ้ำ',
            '10.การฆ่าตัวตาย' => '10.การฆ่าตัวตาย',
            '11.การถูกกีดกัน/ถูกเลือกปฏิบัติจากชุมชนหรือสังคม/ไม่ได้รับความเป็นธรรม' => '11.การถูกกีดกัน/ถูกเลือกปฏิบัติจากชุมชนหรือสังคม/ไม่ได้รับความเป็นธรรม',
            '12.การได้รับการเลี้ยงดู/ดูเเลไม่เหมาะสม' => '12.การได้รับการเลี้ยงดู/ดูเเลไม่เหมาะสม',
            '13.การถูกญาติทอดทิ้ง/ไม่ยอมรับ' => '13.การถูกญาติทอดทิ้ง/ไม่ยอมรับ',
        ];
        $assess_patient_risk = AssessPatientRisk::all();
        $social_support = SocialSupport::all();
        $monitor_and_evaluate = MonitorAndEvaluate::all();
